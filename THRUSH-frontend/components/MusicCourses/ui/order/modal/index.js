            ...
            <div className="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div className="mt-1 relative rounded-md">
                ...
                <input
                  ...
                  name="price"
                  id="price"
                  className="disabled:opacity-50 w-80 mb-1 focus:ring-orange-500 shadow-md focus:border-orange-500 block pl-7 p-4 sm:text-sm border-gray-300 rounded-md"
                />
                ...
                <>
                  <div className="mt-2 relative rounded-md">
                    ...
                    <input
                      ...
                      name="email"
                      id="email"
                      className="w-80 focus:ring-orange-500 shadow-md focus:border-orange-500 block pl-7 p-4 sm:text-sm border-gray-300 rounded-md"
                      placeholder="x@y.com"
                    />
                  ...
                  <div className="my-2 relative rounded-md">
                    ...
                    <input
                      ...
                      className="w-80 focus:ring-orange-500 shadow-md focus:border-orange-500 block pl-7 p-4 sm:text-sm border-gray-300 rounded-md" placeholder="x@y.com" />
                  </div>
                </>
              }
